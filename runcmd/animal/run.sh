...
do
python3 -m scripts.animal.main \
    -F logs/tim_gd/mini \
    with dataset.path="data/animal" \
    ...
    eval.tukey_trans=1 \
    dis_dir="ckpt/animal/dis/" \
    gaussian_dir="ckpt/animal/Gaussian/" \
    test_dir="data/animal/test/" \
    task_dir="data/animal/task/" \
    base_dir="data/animal/base/"
done