...
class DropBlock(nn.Module):
    ...
    def _compute_block_mask(self, mask):
        ...
        offsets = torch.stack(
            [
                torch.arange(self.block_size).view(-1, 1).expand(
                    self.block_size, self.block_size).reshape(-1), # - left_padding,
        ...
        if nr_blocks > 0:
            ...
            padded_mask = F.pad(mask, (left_padding,
                                                               right_padding,
                                                               left_padding,
                                                               right_padding))
            padded_mask[block_idxs[:, 0],
                                        block_idxs[:, 1],
                                        block_idxs[:, 2],
                                        block_idxs[:, 3]] = 1.
        else:
...
#             self.rot_classifier3 = nn.Linear(16, 4)
    ...
    def forward(
        ...
        x_subs = self.adapool(x)
        b, c = x_subs.size(0), x_subs.size(1)
        x_subs = x_subs.view(b, c, -1)
...
def resnet12_ssl(
    ...
    """Constructs a ResNet18-12 model.
    """
...
def resnet24_ssl(
    ...
    """Constructs a ResNet18-24 model.
    """
    model = ResNet(BasicBlock,
                                   [2, 2, 2, 2],
                                   keep_prob=keep_prob,
...
def resnet50_ssl(
    ...
    """Constructs a ResNet18-50 model.
...
def resnet101_ssl(
    ...
    """Constructs a ResNet18-101 model.
...
if __name__ == '__main__':
    ...
    model_dict = {
        'resnet12': resnet12_ssl,
        'resnet18': resnet18_ssl,
        'resnet24': resnet24_ssl,
        'resnet50': resnet50_ssl,
        'resnet101': resnet101_ssl,
